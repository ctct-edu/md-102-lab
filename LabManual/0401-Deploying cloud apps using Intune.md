...
3. **Microsoft Intune管理センター** ページで、[**アプリ]** を選択します。

4. **[アプリ**] ページのナビゲーション ウィンドウで、 **[すべてのアプリ**] を選択します。

5. 詳細ウィンドウで、 **[+ 作成]** を選択します。

6. [**アプリの種類を選択**] ページで、ドロップダウン メニューをクリックし、プラットフォームは **[Windows]**、アプリの種類は **[Microsoft Store アプリ (新規)]** を選択します。

7. **[選択]** をクリックします。

8. [**アプリの追加**] ページで、**Microsoft Store アプリ (新規) を検索する** リンクをクリックします。

9. [**Microsoft Store アプリ (新規) を検索する**] ページで、[**Windows App**] を検索して選択します。**[選択]** をクリックします。
...
2. **アプリ |概要**ブレードで、 **[すべてのアプリ]** を選択します。
3. 詳細ウィンドウで、 **[+ 作成]** を選択します。

4. [**アプリの種類を選択**] ページで、ドロップダウン メニューをクリックし、プラットフォームは **[Windows]**、アプリの種類は **[Microsoft 365 Apps (Windows 10 以降)]** を選択します。
5. **[選択]** をクリックします。
6. [**Microsoft 365 アプリの追加**] ブレードで、次のオプションを構成し、[**次へ**] を選択します。
   - スイート名: **Microsoft 365 Apps (Research)**
   - 説明: **Contoso の研究部門向け Microsoft 365 Apps**
7. [**アプリ スイートの構成]** タブで、[**Office アプリを選択する**] ドロップダウンを展開し、次のアプリのみを選択するようにします。
   - Excel
   - Outlook
   - PowerPoint
   - Word
8. [**アプリ スイートの情報**] セクションで、次のオプションを構成します。
   - アーキテクチャ: **64 ビット**
   - 既定のファイル形式: **Office Open XML 形式**
   - 更新チャネル: **月次エンタープライズ チャネル**
9. [**プロパティ]** セクションで、次のオプションを構成し、[**次へ**] を選択します。
   - ユーザーの代理で Microsoft ソフトウェアライセンス条項に同意する: **はい**
10. [**割り当て]** タブの [**必須]** セクションで、[**グループの追加**] を選択します。
11. [**グループの選択**] ブレードで、 **[Research]** を選択し、 **[選択]** を選択します。
12. [**次へ**] を選択します。[**確認と作成**] タブで、 **[作成]** を選択します。
13. [**Microsoft 365 Apps(Research)]** ページで、[**プロパティ]** を選択します。
14. 詳細ウィンドウで、[**割り当て]** セクションの **[必須]** の下に **[Research**] が表示されていることを確認します。
