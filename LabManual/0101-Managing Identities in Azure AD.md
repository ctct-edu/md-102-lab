...
10. **Microsoft Edge** で新しいタブを開き、アドレス バーに **[「https://admin.microsoft.com](https://admin.microsoft.com/)** 」と入力します。(MFAを要求された場合、[Skip for now]を選択してスキップできます)
...
28. [**名前またはメール アドレスで検索します**] テキスト ボックスに移動し、**Contoso_Managers** グループを選択します。

29. [**ライセンスを割り当てる**] を選択します。

30. [**ライセンスを割り当てられています**] ウィンドウで、右上隅の **[X**] を選択して閉じます。

31. Microsoft 365 管理センターの [ナビゲーション] ウィンドウで、[**課金情報**>**ライセンス**] を選択します。

32. [**サブスクリプション]** の一覧で、[**Office 365 E5 (no Teams)]** を選択します。

33. [**ライセンスの割り当て**] を選択します。

34. [**名前またはメール アドレスで検索します**] テキスト ボックスに移動し、**Contoso_Managers** グループを選択します。

35. [**ライセンスを割り当てる**] を選択します。

36. [**ライセンスを割り当てられています**] ウィンドウで、右上隅の **[X**] を選択して閉じます。[**‎Contoso_Managers‎ にライセンスを割り当てました**] ウィンドウで、右上隅の **[X**] を選択して閉じます。

37. Microsoft 365 管理センターの [ナビゲーション] ウィンドウで、[**課金情報**>**ライセンス**] を選択します。

38. [**サブスクリプション]** の一覧で、[**Office 365 E5 (no Teams)]** を選択します。

> Office 365 E5 (no Teams ライセンスが割り当てられているユーザーとグループを確認します。
>
