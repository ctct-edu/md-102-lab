...
40. **[部門]** の横に「**オペレーション」**と入力します。

41. [**使用場所]** の横にある [**米国**] を選択します。

42. ページの下部にある **[次へ: 割り当て**] を選択します。

43. [**割り当て]** ページで、割り当てが選択されていないことに注意してください。

44. ページの下部にある **[次へ: 確認 + 作成**] を選択します。
