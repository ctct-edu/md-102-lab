...
11. [**コンプライアンス設定]** タブで、[**システム セキュリティ]** を展開します。**[Microsoft Defender マルウェア対策**] 設定を **[必要]** に設定します。
...
13. [**次へ**] を選択します。[**割り当て]** タブの **[含まれるグループ]** で **[グループを追加**] を選択します。**[Windows デバイス]** を選択し、[**選択]** を選択して、[**次へ**] を選択します。

    *注: **Windows デバイス** グループは、ラボ 0301: 構成プロファイルの作成と展開で作成されました。*

14. [**確認および作成**] タブで、設定を確認し、[**作成]** を選択します。

15. ナビゲーション メニューで **[デバイス]** を選択し、[デバイス] ナビゲーション ウィンドウで **[コンプライアンス]** を選択します。

16. **デバイス |[コンプライアンス]** ブレードで、[**コンプライアンス設定]** タブを選択します。
...
4. [**新規]** ブレードの [**名前**] テキスト ボックスに **Conditional1** と入力し、 **0 個のユーザーとグループが選択されました** のリンクを選択します。
5. **[対象]** で、[**すべてのユーザー**] ラジオ ボタンを選択します。
6. [**ターゲット リソース]** セクションで、[**ターゲット リソースが選択されていません**] を選択します。
7. **[対象]** タブで [**リソースの選択**] ラジオ ボタンを選択し、[選択]セクション で [**なし**] を選択し、[**Office 365 Exchange Online**] を選択して、[**選択]** をクリックします。
8. [**条件]** セクションで、**0 個の条件が選択されました** を選択します。
9. 条件のリストで、[**デバイス プラットフォーム**] で [**未構成]** を選択します。[**構成]** セクションで [**はい**] を選択し、[**デバイス プラットフォームの選択**] ラジオ ボタンを選択し、[**Windows**] チェック ボックスをオンにして、[**完了]** を選択します。
10. [**許可]** セクションで、**0 個のコントロールが選択されました**を選択します。[**デバイスは準拠しているとしてマーク済みである必要があります]** チェック ボックスをオンにし、[**選択]** を選択します。
11. [**新規]** ブレードの [**ポリシーをの有効化]** オプションで **[オン**] を選択し、 **[作成]** を選択します。
...
13. Microsoft Edge で、「**outlook.office.com**」と入力し、Enter キーを押します。必要に応じて、「**Pa55w.rd1234!」** のパスワードでサインインします。
